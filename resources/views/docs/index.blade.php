...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="authentication-auth-endpoints-post" class="action post"><h4 class="action-heading"><div class="name">Login</div><a href="#authentication-auth-endpoints-post" class="method post">POST</a><code class="uri">/api/auth/authenticate</code></h4><h4 id="header-attributes">Attributes <a class="permalink" href="#header-attributes" aria-hidden="true">¶</a></h4>
<ul>
<li>
<p><code>phone_number</code> (string, required)</p>
</li>
<li>
<p><code>password</code> (string, required)</p>
</li>
</ul>
</div></div><hr class="split"><div class="right"><div class="definition"><span class="method post">POST</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/auth/verify-phone-number</span></div><div class="tabs"><div class="example-names"><span>Requests</span><span class="tab-button">example 1</span></div><div class="tab"><div><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
    "<span class="hljs-attribute">phone_number</span>": <span class="hljs-value"><span class="hljs-string">"+421944244303"</span></span>,
}</code></pre><div style="height: 1px;"></div></div></div><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span><span class="tab-button">422</span></div><div class="tab"><div><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">phone_number</span>": <span class="hljs-value"><span class="hljs-string">"+421945244303"</span></span>,
  "<span class="hljs-attribute">sms</span>": <span class="hljs-value"><span class="hljs-number">150218</span>
  ...
  "<span class="hljs-attribute">errors</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">phone_number</span>": <span class="hljs-value">[
      <span class="hljs-string">"The phone number has already been taken."</span>
    ]
  </span>}
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="authentication-auth-endpoints-post-1" class="action post"><h4 class="action-heading"><div class="name">Verify phone number</div><a href="#authentication-auth-endpoints-post-1" class="method post">POST</a><code class="uri">/api/auth/verify-phone-number</code></h4><h4 id="header-attributes-1">Attributes <a class="permalink" href="#header-attributes-1" aria-hidden="true">¶</a></h4>
<ul>
<li><code>phone_number</code> (string, required)</li>
  ...
  "<span class="hljs-attribute">uuid</span>": <span class="hljs-value"><span class="hljs-string">"4eacbd40-707b-11e6-8440-6b0424d4dc06"</span></span>,
  "<span class="hljs-attribute">name</span>": <span class="hljs-value"><span class="hljs-string">"John Doe"</span></span>,
  "<span class="hljs-attribute">phone_number</span>": <span class="hljs-value"><span class="hljs-string">"+421944244303"</span></span>,
  "<span class="hljs-attribute">email</span>": <span class="hljs-value"><span class="hljs-string">"john@doe.com"</span></span>,
  "<span class="hljs-attribute">note</span>": <span class="hljs-value"><span class="hljs-string">"some notes"</span></span>,
  "<span class="hljs-attribute">recommendation</span>": <span class="hljs-value"><span class="hljs-string">"some recommendation"</span></span>,
  "<span class="hljs-attribute">credit</span>": <span class="hljs-value"><span class="hljs-number">300</span></span>,
  "<span class="hljs-attribute">credit_currency</span>": <span class="hljs-value"><span class="hljs-string">"€"</span></span>,
  "<span class="hljs-attribute">limit</span>": <span class="hljs-value"><span class="hljs-number">1</span></span>,
  "<span class="hljs-attribute">created_at</span>": <span class="hljs-value"><span class="hljs-string">"2016-09-01 08:02:22"</span>
  ...
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    ...
    "<span class="hljs-attribute">note</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span>
    </span>}</span>,
    "<span class="hljs-attribute">recommendation</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span>
    </span>}</span>,
    "<span class="hljs-attribute">credit</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span>
    </span>}</span>,
    "<span class="hljs-attribute">credit_currency</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span>
    </span>}</span>,
    "<span class="hljs-attribute">limit</span>": <span class="hljs-value">{
      "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"number"</span>
    </span>}</span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div></div><div class="middle"><div id="authentication-auth-endpoints-post-2" class="action post"><h4 class="action-heading"><div class="name">Register</div><a href="#authentication-auth-endpoints-post-2" class="method post">POST</a><code class="uri">/api/auth/register</code></h4><h4 id="header-attributes-2">Attributes <a class="permalink" href="#header-attributes-2" aria-hidden="true">¶</a></h4>
<ul>
<li>
<p><code>name</code> (string, required)</p>
</li>
<li>
...
</div></div><hr class="split"><div class="middle"><section id="me" class="resource-group"><h2 class="group-heading">Me <a href="#me" class="permalink">&para;</a></h2></section></div><div class="middle"><div id="me-me-endpoints" class="resource"><h3 class="resource-heading">me endpoints <a href="#me-me-endpoints" class="permalink">&para;</a></h3></div></div><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/me</span></div><div class="tabs"><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span></div><div class="tab"><div><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">uuid</span>": <span class="hljs-value"><span class="hljs-string">"4eacbd40-707b-11e6-8440-6b0424d4dc06"</span></span>,
  "<span class="hljs-attribute">name</span>": <span class="hljs-value"><span class="hljs-string">"John Doe"</span></span>,
  "<span class="hljs-attribute">phone_number</span>": <span class="hljs-value"><span class="hljs-string">"+421944244303"</span></span>,
  "<span class="hljs-attribute">email</span>": <span class="hljs-value"><span class="hljs-string">"john@doe.com"</span></span>,
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div><div class="middle"><div id="me-me-endpoints-get" class="action get"><h4 class="action-heading"><div class="name">Profile</div><a href="#me-me-endpoints-get" class="method get">GET</a><code class="uri">/api/me</code></h4></div></div><hr class="split"><div class="right"><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname"></span>/api/me/closest-stands</span></div><div class="tabs"><div class="tabs"><div class="example-names"><span>Responses</span><span class="tab-button">200</span></div><div class="tab"><div><div class="inner"><h5>Headers</h5><pre><code><span class="hljs-attribute">Content-Type</span>: <span class="hljs-string">application/json</span></code></pre><div style="height: 1px;"></div><h5>Body</h5><pre><code>{
  "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">uuid</span>": <span class="hljs-value"><span class="hljs-string">"a4c6cff7-297c-436e-b08b-1a4160184323"</span></span>,
    "<span class="hljs-attribute">name</span>": <span class="hljs-value"><span class="hljs-string">"Saleziani"</span></span>,
    "<span class="hljs-attribute">latitude</span>": <span class="hljs-value"><span class="hljs-number">48.15495</span></span>,
    "<span class="hljs-attribute">longitude</span>": <span class="hljs-value"><span class="hljs-number">17.13446</span></span>,
    "<span class="hljs-attribute">photo</span>": <span class="hljs-value"><span class="hljs-string">"null"</span></span>,
    "<span class="hljs-attribute">description</span>": <span class="hljs-value"><span class="hljs-string">"dsdsdss"</span></span>,
    "<span class="hljs-attribute">place_name</span>": <span class="hljs-value"><span class="hljs-string">"Miletocova"</span></span>,
    "<span class="hljs-attribute">service_tag</span>": <span class="hljs-value"><span class="hljs-literal">true</span></span>,
    "<span class="hljs-attribute">distance</span>": <span class="hljs-value"><span class="hljs-number">190</span>
  </span>}
</span>}</code></pre><div style="height: 1px;"></div><h5>Schema</h5><pre><code>{
  "<span class="hljs-attribute">$schema</span>": <span class="hljs-value"><span class="hljs-string">"http://json-schema.org/draft-04/schema#"</span></span>,
  "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"object"</span></span>,
  "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
    "<span class="hljs-attribute">data</span>": <span class="hljs-value">{
      ...
      "<span class="hljs-attribute">properties</span>": <span class="hljs-value">{
        ...
        "<span class="hljs-attribute">place_name</span>": <span class="hljs-value">{
          "<span class="hljs-attribute">type</span>": <span class="hljs-value"><span class="hljs-string">"string"</span>
        </span>}</span>,
        "<span class="hljs-attribute">service_tag</span>": <span class="hljs-value">{
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></div></div><div class="middle"><div id="me-me-endpoints-get-1" class="action get"><h4 class="action-heading"><div class="name">Closest stands</div><a href="#me-me-endpoints-get-1" class="method get">GET</a><code class="uri">/api/me/closest-stands</code></h4><p>Closest stands for my current gps location</p>
</div></div><hr class="split"><div class="middle"><p style="text-align: center;" class="text-muted">Generated by&nbsp;<a href="https://github.com/danielgtaylor/aglio" class="aglio">aglio</a>&nbsp;on 18 Mar 2017</p></div></div></div></div><script>/* eslint-env browser */
