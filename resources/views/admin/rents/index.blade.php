        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form class="filters" action="{{ route('admin.rents.index') }}" method="GET">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-bordered table-hover table-condensed table-striped"
                                        ...
                                        @forelse($rents as $rent)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.bikes.show', $rent->bike->uuid) }}">{{ $rent->bike->bike_num }}</a>
                                                </td>
                                                <td>
                                                    <a href="{{ route('admin.users.profile.show', $rent->user->uuid) }}">{{ $rent->user->email }}</a>
                                                </td>
                                                <td>
                                                    <a href="{{ route('admin.stands.show', $rent->standFrom->uuid) }}">{{ $rent->standFrom->name }}</a>
                                                </td>
                                                <td>
                                                    <a href="{{ route('admin.stands.show', $rent->standTo->uuid ?? '') }}">{{ $rent->standTo->name ?? '' }}</a>
                                                </td>
                                                <td>{{ $rent->old_code }}</td>
                                                <td>{{ $rent->new_code }}</td>
                                                ...
                                                <td>
                                                    <a href="{!! route('admin.bikes.return', ['uuid' => $rent->bike->uuid]) !!}"
                                                       data-toggle="tooltip" title="Return"><i
                                                                class="fa fa-refresh fa-fw"></i></a>
                                                    <a href="{!! route('admin.rents.show', ['uuid' => $rent->uuid]) !!}"
