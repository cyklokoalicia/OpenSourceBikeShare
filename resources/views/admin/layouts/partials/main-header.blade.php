    ...
    <!-- Navbar Right Menu -->
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer"><a href="{{ route('admin.rents.index') }}">See All Rents</a></li>
                    </ul>
                </li><!-- /.messages-menu -->
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ route('admin.users.profile.show', $currentUser->uuid)}}"
            ...
            <!-- Control Sidebar Toggle Button -->
                <li>
                    <a href="#" data-toggle="stand-detail"><i class="fa fa-gears"></i></a>
                </li>
            </ul>
        </div>
    </nav>
