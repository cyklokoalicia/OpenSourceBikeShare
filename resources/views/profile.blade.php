            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <p class="text-muted text-center">{{ $user->roles()->get()->implode('name', ', ') }}</p>

                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Active rents</b> <a class="pull-right">{{ $user->activeRents()->count() }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Rents</b> <a class="pull-right">{{ $user->rents()->count() }}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Credit</b> <a class="pull-right">{{ $user->credit }}</a>
                            </li>
                        </ul>

                        <a href="#" class="btn btn-warning btn-flat"><i class="fa fa-times"></i> Block user</a>
                        <a href="#" class="btn btn-danger btn-flat"><i class="fa fa-trash"></i> Delete user</a>
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
