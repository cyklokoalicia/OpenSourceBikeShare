...
return [
  ...
  'Bike {bikeNum} is already rented.' => 'Bike {bikeNum} is already rented.',
  ...
  'Bike {bikeNum} does not exist.' => 'Bike {bikeNum} does not exist.',
  ...
  'Bike {bikeId} rented out of stack by {userName}. {stackTopBike} was on the top of the stack at {stand}.' => 'Bike {bikeId} rented out of stack by {userName}. {stackTopBike} was on the top of the stack at {stand}.',
  'Bike {bikeId} is not rentable now, you have to rent bike {stackTopBike} from this stand.' => 'Bike {bikeId} is not rentable now, you have to rent bike {stackTopBike} from this stand.',
  'You have already rented the bike {bikeNum}. Code is {currentCode}.' => 'You have already rented the bike {bikeNum}. Code is {currentCode}.',
  'Bike {bikeNum}: <span class="badge badge-primary">Open with code {currentCode}.</span></h3><h3>Change code immediately to <span class="badge badge-primary">{newCode}</span></h3>(open, rotate metal part, set new code, rotate metal part back).' => 'Bike {bikeNum}: <span class="badge badge-primary">Open with code {currentCode}.</span></h3><h3>Change code immediately to <span class="badge badge-primary">{newCode}</span></h3>(open, rotate metal part, set new code, rotate metal part back).',
  'Reported issue: <em>{note}</em>' => 'Reported issue: <em>{note}</em>',
  'System override: Your rented bike {bikeNum} has been rented by admin.' => 'System override: Your rented bike {bikeNum} has been rented by admin.',
  ...
  'Bike {bikeNum} returned to stand {stand}: <span class="badge badge-primary">Lock with code {currentCode}.</span></h3><br />Please, <strong>rotate the lockpad to <span class="badge badge-primary">0000</span></strong> when leaving. Wipe the bike clean if it is dirty, please.' => 'Bike {bikeNum} returned to stand {stand}: <span class="badge badge-primary">Lock with code {currentCode}.</span></h3><br />Please, <strong>rotate the lockpad to <span class="badge badge-primary">0000</span></strong> when leaving. Wipe the bike clean if it is dirty, please.',
  'You have also reported this problem: {note}.' => 'You have also reported this problem: {note}.',
  'Bicycle {bikeId} is not rented right now. Revert not successful!' => 'Bicycle {bikeId} is not rented right now. Revert not successful!',
  'Bike {bikeId} reverted to <span class="badge badge-primary">{stand}</span> with code <span class="badge badge-primary">{code}</span>.' => 'Bike {bikeId} reverted to <span class="badge badge-primary">{stand}</span> with code <span class="badge badge-primary">{code}</span>.',
  'No last stand or code for bicycle {bikeId} found. Revert not successful!' => 'No last stand or code for bicycle {bikeId} found. Revert not successful!',
  'at {standName}' => 'at {standName}',
  'used by {userName} +{phone}' => 'used by {userName} +{phone}',
  'Note #{noteId}: b.{bikeNum} ({bikeStatus}) by {userName}/{phone}:{userNote}' => 'Note #{noteId}: b.{bikeNum} ({bikeStatus}) by {userName}/{phone}:{userNote}',
